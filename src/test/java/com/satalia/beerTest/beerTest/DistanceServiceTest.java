...
public class DistanceServiceTest {
    ...
    public void calculateDistanceTest(){
        double actualDistance =  distanceService.calculateDistance(51.74250300, 19.43295600,51.74250300, 19.43295600);
        Assert.assertEquals(0, actualDistance, 0d);

        double actualDistance1 = distanceService.calculateDistance(51.74250300, 19.43295600, 49.96220016, 20.60029984);
        Assert.assertEquals(214, actualDistance1, 0d);

        double actualDistance2 = distanceService.calculateDistance(49.96220016, 20.60029984, 52.673900060,14.90040016);
